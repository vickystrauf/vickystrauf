  ...
  return (
    <Layout color="#f2f0ed">
      ...
      >
        ...
        <p>
          You would like to have a fast running and unique website? You are just
          starting your business and don't want to spend a lot of money on
          Squarespace or Wix? Hit me a message and we can discuss your needs and
          I will tell your what I can do better than Squarespace and Wix.
        </p>
      </AnimatedBox>
      <Wrapper>
      ...
      >
        ...
        <WrapperWork>
          <Circle>1</Circle>
          <Steps>
            First of all we schedule a Skype or face-to-face meeting where you
            will tell me more about your business and your needs
          </Steps>
          <Circle>2</Circle>
          <Steps>
            Lets's have some fun! I will start to work on your design and update
            you with drafts.
          </Steps>
          <Circle>3</Circle>
          <Steps>
            After I have done my job, I need you to give me an honest feedback
            on my work. I will do minor changes, so you are happy.
          </Steps>
          <Circle>4</Circle>
          <Steps>
            After going through the last couple of changes, I will deliver the
            final designs/walk you through your website.
          </Steps>
        </WrapperWork>
