    ...
    <Layout color="#f2f0ed">
      ...
      <Wrapper>
        ...
        >
          ...
          <p>
            You would like to have a fast running and unique website? You are
            just starting your business and don't want to spend a lot of money
            on Squarespace or Wix? Hit me a message and we can discuss your
            needs and I will tell your what I can do better than Squarespace and
            Wix.
          </p>
        </AnimatedBox>
        ...
        <Container>
          <Row>
            <ServiceTitle>LOGO</ServiceTitle>
            <Service>
              I will design a beautiful Logo to give your business a remorable
              frontdoor.
            </Service>
          </Row>
          <Row>
            <ServiceTitle>BUSINESS CARD</ServiceTitle>
            <Service>
              Get known by people and leave them your details with a beautiful
              business card.
            </Service>
          </Row>
        </Container>
        ...
        <Container>
          ...
          <Row>
            <Fancy color="#ff1654">2</Fancy>3 drafts
          </Row>
          <Row>
        ...
        <Container>
          <Row>
            <ServiceTitle>PLATFORM</ServiceTitle>
            <Service>
              I will design a beautiful Logo to give your business a remorable
              frontdoor.
            </Service>
          ...
          <Row>
            <ServiceTitle>CUSTOM</ServiceTitle>
            <Service>
              Get known by people and leave them your details with a beautiful
              business card.
            </Service>
