  ...
  return (
    <Layout color="#f2f1f0">
      ...
      >
        ...
        <p>
          a self taught Graphic and Webdesigner living in Sydney. Creating
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                ...
                time on fiverr but prefer to meet someone in person
              </li>
            </ul>
          </div>
          Don’t know where to start and what you need for your business? Get in
          touch with me and I will get you started, help you to create beautiful
